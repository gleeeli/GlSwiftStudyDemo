...
open class JXPagingListContainerView: UIView {
    ...
    weak open var jxdelegate: JXPagingListContainerViewDelegate?
    ...
    private var isScrollEnable: Bool = true
    ...
    open func updateIsScrollEnable(scrollEnable: Bool) {
    ...
    private func listDidAppear(at index: Int) {
        ...
        jxdelegate?.listContainerView?(self, listDidAppearAt: index)
    }
...
extension JXPagingListContainerView: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        print("validListDict默认的index：\(indexPath.item)")
        if list != nil {
    ...
    public func scrollViewDidScroll(_ scrollView: UIScrollView) {
        jxdelegate?.listContainerViewDidScroll?(self)
    ...
    public func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        jxdelegate?.listContainerViewDidEndScrolling?(self)
    }

    public func scrollViewWillBeginDragging(_ scrollView: UIScrollView) {
        jxdelegate?.listContainerViewWillBeginDragging?(self)
    }
