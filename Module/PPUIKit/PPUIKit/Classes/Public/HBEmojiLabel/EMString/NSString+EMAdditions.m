...
#import <HBPublic/XHBConstants.h>
//#import "CMCommonDefine.h"
...
- (NSAttributedString *)attributedString {
    ...
    string = [self styleKeywordForString:string];
...
//    if (Isios7()) {
        ...
        font = [UIFont fontWithDescriptor:desc size:[EMStringStylingConfiguration sharedInstance].defaultFont.pointSize];
//    } else {
//        font = [UIFont italicSystemFontOfSize:[EMStringStylingConfiguration sharedInstance].defaultFont.pointSize];
//    }
 ...
 *  by Soldier
 */
- (NSAttributedString *)styleKeywordForString:(NSAttributedString *)attributedString {
    //关键词
    EMStylingClass *stylingClass = [[EMStylingClass alloc] init];
    stylingClass.markup = kEMKeywordMarkup;
    stylingClass.attributes = @{NSForegroundColorAttributeName : [EMStringStylingConfiguration sharedInstance].keywordColor};
    return [self applyStylingClass:stylingClass forAttributedString:attributedString];
}
