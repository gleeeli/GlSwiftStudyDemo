...
//    var titles = [String]()
    var titles = ["CoreText","策略模式","非策略模式的普通方式实现","tableview的顶部刷新","命令模式","异常","block使用","RxSwift使用","日期","字符串和富文本","翻页效果","模糊效果","滚动渐变","上下滚动文字效果","OC类","自定义有优先级的弹窗Swift","自定义兼容性强弹窗OC","UIButton"]
